...
public class DocumentSearchRestController {
    ...
    public ResponseEntity<RicePagedResources<DocumentResource>> getDocuments(@ApiParam(value = "Principal Id of user to retrieve documents for") @RequestParam(value = "principalId", required = true) String principalId,
        ...
        DocumentSearchResults serviceResults = KEWServiceLocator.getDocumentSearchService().lookupDocuments(principalId, serviceCriteria);
    ...
    public ResponseEntity<DocumentResource> getDocumentById(@ApiParam(value = "Id of the document", required = true) @PathVariable String id) {
        ...
        return ResponseEntity.ok(documentResourceAssembler.toResource(document));
    }
}
